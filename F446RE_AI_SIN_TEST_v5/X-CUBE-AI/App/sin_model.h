...
#ifndef __AI_SIN_MODEL_H__
#define __AI_SIN_MODEL_H__
#pragma once
...
#define AI_SIN_MODEL_IN_1_SIZE  (1 * 1 * 1)
#define AI_SIN_MODEL_IN_1_SIZE_BYTES  ((1 * 1 * 1) * 4)
...
#define AI_SIN_MODEL_OUT_1_SIZE  (1 * 1 * 1)
#define AI_SIN_MODEL_OUT_1_SIZE_BYTES  ((1 * 1 * 1) * 4)
