...
#define STEPPER_4_Pin GPIO_PIN_10
...
#define STEPPER_1_Pin GPIO_PIN_3
#define STEPPER_1_GPIO_Port GPIOB
#define STEPPER_3_Pin GPIO_PIN_4
#define STEPPER_3_GPIO_Port GPIOB
#define STEPPER_2_Pin GPIO_PIN_5
#define STEPPER_2_GPIO_Port GPIOB
#define CAN1_CS_Pin GPIO_PIN_6
